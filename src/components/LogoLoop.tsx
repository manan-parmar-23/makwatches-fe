...
export interface LogoLoopProps {
  ...
  /** Optional large heading shown above the logos */
  heading?: string;
  /** Optional subtitle / description shown below the heading */
  subtitle?: string;
  ariaLabel?: string;
  className?: string;
...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    fadeOutColor,
    scaleOnHover = false,
    heading = "Cutting-edge technology meets timeless design",
    subtitle = "Precision craftsmanship meets modern innovation in every Makwatch timepiece",
    ...
    return (
      <div className="w-full pb-8 bg-transparent">
        {/* Heading section matching provided design */}
        {(heading || subtitle) && (
          <div className="w-full text-center mb-12">
            ...
            {heading && (
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-gray-700 mb-4 max-w-4xl mx-auto px-4">
                {heading}
              </h2>
            )}
            {subtitle && (
